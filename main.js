const translations = {
    pt: {
        ...
        job2_desc1: "<strong>Gestão Institucional:</strong> Fundação e estruturação jurídica da entidade, liderando uma equipe operacional de 30 membros.",
        job2_desc2: "<strong>Controle Financeiro:</strong> Início com caixa do zero e entrega da gestão com superávit líquido de +R$ 4.000 através de controle de custos e receita.",
        job2_desc3: "<strong>Execução de Projetos:</strong> Organização e supervisão de execução de eventos e projetos acadêmicos com foco em viabilidade acadêmica e econômica.",
    ...
    en: {
        ...
        job2_desc1: "<strong>Institutional Management:</strong> Founded and legally structured the organization, leading an operational team of 30 members.",
        job2_desc2: "<strong>Financial Control:</strong> Started from zero cash and delivered the administration with a net surplus of +R$ 4,000 through cost and revenue control.",
        job2_desc3: "<strong>Project Execution:</strong> Organized and supervised the execution of events and academic projects focused on academic and economic viability.",
    ...
    es: {
        ...
        job2_desc2: "<strong>Control Financiero:</strong> Inicio con caja desde cero y entrega de la gestión con un superávit neto de +R$ 4.000 mediante control de costos e ingresos.",
        job2_desc3: "<strong>Ejecución de Proyectos:</strong> Organización y supervisión de la ejecución de eventos y proyectos académicos con foco en viabilidad académica y económica.",
