...
window.translations = {
    pt: {
        ...
        summary_text: "Sou um profissional de atuação híbrida em Gestão Comercial e Desenvolvimento Digital. Combino a experiência prática em vendas <em>consultivas</em> de alto valor com competência técnica em desenvolvimento de ferramentas digitais e produção audiovisual. Meu foco é na execução: utilizo dados para qualificar leads, crio ferramentas digitais para otimizar processos e produzo conteúdo visual para suporte direto a vendas. Orientado a eficiência operacional e resultados financeiros.",
        ...
        job1_desc1: "<strong>Vendas Consultivas:</strong> Gestão do serviço de venda de consultoria consultiva e jurídica do ciclo de vendas de imóveis leiloados com ticket entre R$ 120k e R$ 2.5M, com atuação em ativos acima de R$ 13M.",
        job1_desc2: "<strong>Qualificação de Leads:</strong> Criação de um CRM em Excel de análise de dados para filtragem de oportunidades no CRM, aumentando a taxa de conversão real do funil.",
        ...
        job3_desc1: "<strong>Projetos Web:</strong> Desenvolvimento de interfaces e landing pages (HTML/CSS/JS) focadas em conversão e velocidade.",
        ...
        job3_desc3: "<strong>Cobertura e Edição de Eventos:</strong> Produção, edição rápida e design gráfico para eventos corporativos — cobertura e edição em tempo real do Fórum Ambição 2030 (Pacto Global da ONU – Rede Brasil), Teatro Santander, São Paulo, agosto de 2025.",
    ...
    es: {
        ...
        summary_text: "Soy un profesional con actuación híbrida en Gestión Comercial y Desarrollo Digital. Combino experiencia práctica en ventas consultivas de alto valor con competencia técnica en desarrollo de herramientas digitales y producción audiovisual. Mi foco está en la ejecución: uso datos para cualificar leads, creo herramientas digitales para optimizar procesos y produzco contenido visual para soporte directo a ventas. Orientado a la eficiencia operativa y resultados financieros.",
        ...
        job1_desc1: "<strong>Ventas Consultivas:</strong> Gestión del servicio de venta de consultoría consultiva y jurídica del ciclo de ventas de inmuebles subastados con ticket entre R$ 120k y R$ 2.5M, con actuación en activos por encima de R$ 13M.",
        job1_desc2: "<strong>Calificación de Leads:</strong> Creación de un CRM en Excel para análisis de datos y filtrado de oportunidades en el CRM, aumentando la tasa de conversión real del embudo.",
        job1_desc3: "<strong>Optimización de Rutina:</strong> Reestructuración de procesos de seguimiento y atención, reduciendo el tiempo operativo por cliente.",
        job2_title: "Fundador y Presidente",
        job2_company: "CARI PUCCAMP",
        job2_desc1: "<strong>Gestión Institucional:</strong> Fundación y estructuración jurídica de la entidad, liderando un equipo operativo de 30 miembros.",
        job2_desc2: "<strong>Control Financiero:</strong> Inicio con caja cero y cierre de gestión con superávit neto de +R$ 4.000 mediante control de costos e ingresos.",
        job2_desc3: "<strong>Ejecución de Proyectos:</strong> Organización y supervisión de eventos y proyectos académicos con foco en viabilidad económica.",
        job3_title: "Productor Digital y Desarrollador",
        job3_company: "Autónomo",
        job3_desc1: "<strong>Proyectos Web:</strong> Desarrollo de interfaces y landing pages (HTML/CSS/JS) enfocadas en conversión y velocidad.",
        ...
        job3_desc3: "<strong>Cobertura y Edición de Eventos:</strong> Producción, edición rápida y diseño gráfico para eventos corporativos — cobertura y edición en tiempo real del Fórum Ambição 2030 (Pacto Global de la ONU – Red Brasil), Teatro Santander, São Paulo, agosto de 2025.",
