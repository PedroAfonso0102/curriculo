const translations = {
    pt: {
        ...
        sidebar_resume: "Currículo",
        sidebar_playground: "Playground",
        sidebar_outline: "Neste documento",
        playground_title: "Playground",
        playground_subtitle: "Área de Testes e Experimentação",
        section_experiments: "Experimentos",
        exp_fluid_title: "Fluid Simulation",
        exp_fluid_desc: "Simulação de fluidos interativa.",
        exp_gravity_title: "Gravity",
        exp_gravity_desc: "Sistema de partículas gravitacionais.",
        exp_pendulum_title: "Double Pendulum",
        exp_pendulum_desc: "Pêndulo duplo caótico.",
        exp_fourier_title: "Fourier Series",
        exp_fourier_desc: "Visualização de ondas quadradas.",
        back_to_dashboard: "← Voltar para Dashboard",
        fluid_caption: "Clique e arraste para interagir com o fluido.",
        gravity_caption: "Clique e arraste para lançar novos corpos celestes."
    },
    en: {
        ...
        sidebar_playground: "Playground",
        sidebar_outline: "In this document",
        playground_title: "Playground",
        playground_subtitle: "Testing & Experimentation Area",
        section_experiments: "Experiments",
        exp_fluid_title: "Fluid Simulation",
        exp_fluid_desc: "Interactive fluid simulation.",
        exp_gravity_title: "Gravity",
        exp_gravity_desc: "Gravitational particle system.",
        exp_pendulum_title: "Double Pendulum",
        exp_pendulum_desc: "Chaotic double pendulum.",
        exp_fourier_title: "Fourier Series",
        exp_fourier_desc: "Square wave visualization.",
        back_to_dashboard: "← Back to Dashboard",
        fluid_caption: "Click and drag to interact with the fluid.",
        gravity_caption: "Click and drag to launch new celestial bodies."
    },
    es: {
        ...
        // Sidebar & Playground
        sidebar_pages: "Páginas",
        sidebar_resume: "Currículum",
        sidebar_playground: "Playground",
        sidebar_outline: "En este documento",
        playground_title: "Playground",
        playground_subtitle: "Área de Pruebas y Experimentación",
        section_experiments: "Experimentos",
        exp_fluid_title: "Fluid Simulation",
        exp_fluid_desc: "Simulación de fluidos interactiva.",
        exp_gravity_title: "Gravity",
        exp_gravity_desc: "Sistema de partículas gravitacionales.",
        exp_pendulum_title: "Double Pendulum",
        exp_pendulum_desc: "Péndulo doble caótico.",
        exp_fourier_title: "Fourier Series",
        exp_fourier_desc: "Visualización de ondas cuadradas.",
        back_to_dashboard: "← Volver al Panel",
        fluid_caption: "Haz clic y arrastra para interactuar con el fluido.",
        gravity_caption: "Haz clic y arrastra para lanzar nuevos cuerpos celestes."
    }
};
